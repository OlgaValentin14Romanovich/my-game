...
param - parameter
l - long
rect - rectangle >> пр€моугольник
alloc - allocate - размечать пам€ть
...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd) {
	...
	WindowClass.style = CS_HREDRAW | CS_VREDRAW; // <--- задаЄм когда будет перерисовыватьс€ окно
	WindowClass.lpszClassName = TEXT("Game Window Class"); // <--- название класса окна
	WindowClass.lpfnWndProc = windowClick; // <--- мы прив€зываем к классу функцию обработчик кликов по окну
